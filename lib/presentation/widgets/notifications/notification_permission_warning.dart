...
class ExactAlarmPermissionWarning extends StatelessWidget {
  final VoidCallback? onOpenExactAlarmSettings;

  const ExactAlarmPermissionWarning({super.key, this.onOpenExactAlarmSettings});
          ...
          const Expanded(
            child: Column(
              ...
              children: [
                ...
                SizedBox(height: 4),
                Text(
                  'Hassas bildirim zamanlaması için izin gerekiyor.',
