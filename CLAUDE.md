# Ezan Vakti — Proje Talimatları

## Kapsam ve bakım

Bu dosya, bu repository üzerinde çalışan Claude Code için proje talimatıdır. Proje kurallarını yalnızca burada güncelle; ikinci bir kopyasını başka dosyada tutma.
